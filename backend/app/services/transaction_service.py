...
class TransactionService:
    ...
    def get_user_transactions(
        ...
        if transaction_type:
            user_transactions = [t for t in user_transactions if t.transaction_type == transaction_type]
    ...
    def get_transaction_by_id(self, transaction_id: str, user_id: str) -> Optional[Transaction]:
        transaction_data = self.db.find_one(self.collection, {"id": transaction_id, "user_id": user_id})
        if transaction_data:
    ...
    def update_transaction(
        ...
        if success:
            return self.get_transaction_by_id(transaction_id, user_id)
        return None
